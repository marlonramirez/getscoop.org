<div class="col-3">
    ...
    acceso y entender el funcionamiento del bootstrap en profundidad.</p>
    <p>Se puede hallar una lista completa del roadmap en el <a href="{{#view->route('welcome')}}">siguiente enlace</a>.</p>
</div>

<div class="col-3">
    <h2 class="h-green"><i class="fa fa-money"></i> Contribuye</h2>
    <p>Puedes contribuir  mediante pull requests al repositorio en
...
<div class="col-3">
    ...
    <ul class="data-contributor">
        ...
        <li>Arquitectura y desarrollo</li>
        <li>
        ...
        <li>
            <a href="http://twitter.com/marloniramirez" rel="external">
                <i class="fa fa-twitter"></i> @marloniramirez
            </a>
        </li>
        <li>
