...
<p>La inversión de control es un término genérico que puede implementarse de diferentes maneras. Por ejemplo 
se puede implementar mediante eventos o como lo hace scoop mediante Inyección de Dependencias.</p>